...
import static fr.xelians.sipg.TestUtils.*;
...
public class Sedav2Test {
    ...
    void testValidateXml(TestInfo testInfo) {
        LOGGER.info(TEST + getMethod(testInfo));
        ...
        try {
            ...
            String msg = FAIL + getMethod(testInfo);
            LOGGER.warn(msg, ex);
            fail(msg);
        }
    }
    ...
    void testWithoutAgencyFail(TestInfo testInfo) {
        ...
        assertThrows(SipgException.class, () -> sedaService.write(archiveTransfer, outputPath));
    }
