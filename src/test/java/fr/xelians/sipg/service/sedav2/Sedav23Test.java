...
public class Sedav23Test {
  ...
  void testUnMarshalSmallArchiveTransferType(TestInfo testInfo) {
    ...
    try (InputStream sedaStream = getClass().getClassLoader().getResourceAsStream("seda-2.3/seda_small.xml")) {
      final var attUnMarshalled = Sedav2Service.getV23Instance().unmarshal(sedaStream, ArchiveTransferType.class, sedaConfig);
