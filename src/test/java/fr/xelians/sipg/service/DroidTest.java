...
class DroidTest {
     ...
     */
    @Test
    void testSmallPdfDroid() throws Exception {
        Path path = Paths.get(TestInit.TEST_RESOURCES + "dummy.pdf");
        List<IdentificationResult> results = SipUtils.matchBinarySignatures(path);
     ...
     */
    @Test
    void testMediumPdfDroid() throws Exception {
     ...
     */
    @Test
    void testLoopDroid() throws Exception {
        Path path = Paths.get(TestInit.TEST_RESOURCES + "citizenfour.pdf");
