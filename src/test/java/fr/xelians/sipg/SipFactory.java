...
public class SipFactory {
    ...
    public static ArchiveTransfer createSimpleSip(FileSystem fs) {
        ...
        unit1.addAddressee(AgentBuilder.builder()
                ...
                .withBirthPlace(PlaceBuilder.builder().withAddress("19 Holliday Street").withGeogname("GEOName").withPostalCode("94300").withRegion("Oregon").withCountry("USA").withCity("NY").build())
                .build());
