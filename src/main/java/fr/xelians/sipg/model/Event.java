...
/**
 * La classe Event représente un évènement, généralement issu d'un journal des opérations ou d'un
 * journal du cycle de vie, et qui est associé à une unité d'archive.
 *
