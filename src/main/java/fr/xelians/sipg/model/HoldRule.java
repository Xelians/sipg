...
public class HoldRule extends Rule {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getHoldEndDate(), holdRule.getHoldEndDate())
        && Objects.equals(getHoldOwner(), holdRule.getHoldOwner())
        && Objects.equals(getHoldReason(), holdRule.getHoldReason())
        && Objects.equals(getHoldReassessingDate(), holdRule.getHoldReassessingDate())
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        getHoldOwner(),
        getHoldReason(),
        getHoldReassessingDate(),
        getPreventRearrangement());
  }
}
