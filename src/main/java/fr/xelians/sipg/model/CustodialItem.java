...
/**
 * La classe CustodialItem représente la description d'une période ou d'un événement précis dans
 * l'historique.
 *
...
public class CustodialItem {
   ...
   */
  @JsonCreator
  public CustodialItem(
      @JsonProperty("value") String value, @JsonProperty("when") LocalDateTime when) {
