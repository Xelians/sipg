...
/**
 * La classe FileInfo représente les propriétés techniques génériques du fichier de l'objet binaire
 * (nom d’origine, logiciel de création, système d’exploitation de création).
 *
