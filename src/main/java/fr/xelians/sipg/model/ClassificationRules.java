...
public class ClassificationRules extends AbstractSimpleRules {
  ...
  /**
   * L'audience qui permet de gérer les questions de "diffusion restreinte", de "spécial France" et
   * de "Confidentiel Industrie".
   */
  ...
  /**
   * Indique l'audience qui permet de gérer les questions de "diffusion restreinte", de "spécial
  ...
  /**
   * Spécifie l'audience qui permet de gérer les questions de "diffusion restreinte", de "spécial
   * France" et de "Confidentiel Industrie".
   *
