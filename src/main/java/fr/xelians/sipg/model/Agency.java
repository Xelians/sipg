...
/**
 * La classe Agency représente un service agent. Il existe plusieurs types de services agents.
 * ArchivalAgency : service d'archives responsable de la demande de communication ou de restitution.
 * OriginatingAgency : service producteur ou "Personne physique ou morale, publique ou privée, qui a
 * produit, reçu et conservé des archives dans l'exercice de son activité" (Dictionnaire de
 * terminologie archivistique, direction des archives de France, 2002). SubmissionAgency : service
 * versant responsable du transfert des données. TransferringAgency : service versant chargé de
