...
public class HoldRules extends AbstractRules {
     ...
     */
    public HoldRules(String name, LocalDate startDate, LocalDate holdEndDate, String holdOwner, String holdReason, LocalDate holdReassessingDate, Boolean preventRearrangement) {
        super();
        addRule(name, startDate, holdEndDate, holdOwner, holdReason, holdReassessingDate, preventRearrangement);
    }
