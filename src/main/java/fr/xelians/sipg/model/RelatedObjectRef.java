...
/**
 * La classe RelatedObjectRef représente la référence à un ensemble d'objets faisant ou ne faisant
 * pas partie du présent paquet d'information.
 *
...
public class RelatedObjectRef {
  ...
  /**
   * La liste des références de type "Est une version de". Cette relation permet d'indiquer les
   * modifications dans le contenu présent paquet d'information (édition, adaptation, traduction).
   */
  protected final List<RelationRef<?>> isVersionOfs = new ArrayList<>();

  /**
   * La liste des références de type "Remplace". Cette relation permet d'indiquer les objets
   * remplacés par le niveau courant de description.
   */
  protected final List<RelationRef<?>> replaces = new ArrayList<>();

  /**
   * La liste des références de type "Requiert". Cette relation permet d'indiquer les objets
   * nécessaires à la compréhension du niveau courant de description.
   */
  protected final List<RelationRef<?>> requires = new ArrayList<>();

  /**
   * La liste des références de type "Est une partie de". Cette relation permet d'indiquer qu'un
   * objet est une partie d'un autre.
   */
  protected final List<RelationRef<?>> isPartOfs = new ArrayList<>();

  /**
   * La liste des références de type "Référence". Cette relation permet d'indiquer qu'un objet en
   * référence un autre.
   */
  protected final List<RelationRef<?>> references = new ArrayList<>();
  ...
  /**
   * Ajoute une référence à la liste des références de type "Est une version de". Cette relation
   * permet d'indiquer les modifications dans le contenu présent paquet d'information (édition,
  ...
  /**
   * Fournit la liste des références de type "Est une version de". Cette relation permet d'indiquer
   * les modifications dans le contenu présent paquet d'information (édition, adaptation,
   * traduction).
   *
  ...
  /**
   * Ajoute une référence à la liste des références de type "Remplace". Cette relation permet
   * d'indiquer les objets remplacés par le niveau courant de description.
   *
  ...
  /**
   * Fournit la liste des références de type "Remplace". Cette relation permet d'indiquer les objets
   * remplacés par le niveau courant de description.
   *
  ...
  /**
   * Ajoute une référence à la liste des références de type "Requiert". Cette relation permet
   * d'indiquer les objets nécessaires à la compréhension du niveau courant de description.
   *
  ...
  /**
   * Fournit la liste des références de type "Requiert". Cette relation permet d'indiquer les objets
   * nécessaires à la compréhension du niveau courant de description.
   *
  ...
  /**
   * Ajoute une référence à la liste des références de type "Est une partie de". Cette relation
   * permet d'indiquer qu'un objet est une partie d'un autre.
   *
  ...
  /**
   * Fournit la liste des références de type "Est une partie de". Cette relation permet d'indiquer
  ...
  /**
   * Ajoute une référence à la liste des références de type "Référence". Cette relation permet
   * d'indiquer qu'un objet en référence un autre.
   *
  ...
  /**
   * Fournit la liste des références de type "Référence". Cette relation permet d'indiquer qu'un
   * objet en référence un autre.
   *
