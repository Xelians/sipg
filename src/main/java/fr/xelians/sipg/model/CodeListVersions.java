...
public class CodeListVersions {
    ...
    /**
     * La version de la liste de codes correspondant aux diverses versions d'un objet-données au sein d’un groupe
     ...
     *
     * @param compressionAlgorithmCodeListVersion la version de la liste de code de l'algorithme de compression
     */
    ...
    /**
     * Indique la version de la liste de codes correspondant aux versions d'un objet-données au sein d’un groupe
     * d'objets-données (ex. original papier, conservation, diffusion, vignette, txt).
     *
    ...
    /**
     * Spécifie la version de la liste de codes correspondant aux versions d'un objet-données au sein d’un groupe
     * d'objets-données (ex. original papier, conservation, diffusion, vignette, txt).
     *
     ...
     *
     * @param storageRuleCodeListVersion la version de la liste des codes pour les règles de durée d'utilité courante
     */
     ...
     *
     * @param accessRuleCodeListVersion la version de la liste des codes pour les règles de communicabilité
     */
     ...
     *
     * @param disseminationRuleCodeListVersion la version de la liste des codes pour les règles de diffusion
     */
     ...
     *
     * @param classificationRuleCodeListVersion la version de la liste des codes pour les règles de classification
     */
     ...
     *
     * @param acquisitionInformationCodeListVersion la version de la liste de codes des modalités d'entrée
     */
    public void setAcquisitionInformationCodeListVersion(String acquisitionInformationCodeListVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.authorizationReasonCodeListVersion, other.authorizationReasonCodeListVersion)) {
            return false;
        }
        ...
        if (!Objects.equals(this.messageDigestAlgorithmCodeListVersion, other.messageDigestAlgorithmCodeListVersion)) {
            return false;
        }
        ...
        if (!Objects.equals(this.signatureStatusCodeListVersion, other.signatureStatusCodeListVersion)) {
            return false;
        }
        ...
        if (!Objects.equals(this.compressionAlgorithmCodeListVersion, other.compressionAlgorithmCodeListVersion)) {
            return false;
        }
        if (!Objects.equals(this.dataObjectVersionCodeListVersion, other.dataObjectVersionCodeListVersion)) {
            return false;
        }
        ...
        if (!Objects.equals(this.disseminationRuleCodeListVersion, other.disseminationRuleCodeListVersion)) {
            return false;
        }
        if (!Objects.equals(this.reuseRuleCodeListVersion, other.reuseRuleCodeListVersion)) {
            return false;
        }
        if (!Objects.equals(this.classificationRuleCodeListVersion, other.classificationRuleCodeListVersion)) {
            return false;
        }
        return Objects.equals(this.acquisitionInformationCodeListVersion, other.acquisitionInformationCodeListVersion);
    }
