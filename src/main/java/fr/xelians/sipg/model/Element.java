...
/**
 * La classe Element représente un élément utilisé dans le cadre d'une extension de l'ontologie
 * définie généralement par le schéma XSD du standard d'échange. Il est composé d'un nom, d'une
 * valeur et d'un ensemble d'attributs. Un élément peut également contenir une liste d'éléments
 * enfants.
 *
...
public class Element {
   ...
   * @return la valeur précédemment associée à la clé ou nulle si la clé n'était associée à aucun
   *     attribut
   */
