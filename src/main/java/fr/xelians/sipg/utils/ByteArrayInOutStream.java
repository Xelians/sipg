...
/**
 * This class extends the ByteArrayOutputStream by providing a method that returns a new ByteArrayInputStream which uses
 * the internal byte array buffer. This buffer is not copied, so no additional memory is used. After creating the
 * ByteArrayInputStream the instance of the ByteArrayInOutStream can not be used anymore.
 * <p>
...
public class ByteArrayInOutStream extends ByteArrayOutputStream {
    ...
    /**
     * Creates a new ByteArrayInOutStream. The buffer capacity is initially 32 bytes, though its size increases if
     * necessary.
     */
