 ...
 */
public class SedaResolver implements LSResourceResolver {

  private static final Logger LOGGER = LoggerFactory.getLogger(SedaResolver.class);
   ...
   */
  public SedaResolver(InputStream xmlInputStream, InputStream xlinkInputStream) {
  ...
  public LSInput resolveResource(
    ...
    return switch (systemId) {
      ...
      case "http://www.w3.org/1999/xlink.xsd" ->
          new LSInputImpl(publicId, systemId, xlinkInputStream);
      default -> {
