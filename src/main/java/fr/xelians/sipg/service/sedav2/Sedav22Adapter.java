...
public class Sedav22Adapter implements Sedav2Adapter {
  ...
  private static final NamespacePrefixMapper namespaceMapper =
      new NamespacePrefixMapper() {
        public String getPreferredPrefix(
          ...
          return !requirePrefix && "fr:gouv:culture:archivesdefrance:seda:v2".equals(namespaceUri)
              ? ""
              : "ns";
        }
      };
  ...
  static {
    ...
    try (InputStream is1 = SipUtils.resourceAsStream("seda-vitam-2.2-full.xsd");
      ...
      sedaContext =
          JAXBContext.newInstance(fr.gouv.culture.archivesdefrance.seda.v2.ObjectFactory.class);
