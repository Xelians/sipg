 ...
 * @see SedaConfig
 */
public class SedaConfigBuilder {
   ...
   * @return le builder
   */
  public static SedaConfigBuilder builder() {
    return new SedaConfigBuilder();
  }
   ...
   * @return le builder
   */
  public SedaConfigBuilder validate(boolean validate) {
   ...
   * @return le builder
   */
  public SedaConfigBuilder format(boolean format) {
    this.format = format;
    return this;
  }
   ...
   * @return le builder
   */
  public SedaConfigBuilder indent(int indent) {
    this.indent = indent;
    return this;
  }
   ...
   * @return le builder
   */
  public SedaConfigBuilder thread(int thread) {
    this.thread = thread;
    return this;
  }
   ...
   * @return le builder
   */
  public SedaConfigBuilder strict(boolean strict) {
    this.strict = strict;
    return this;
  }
   ...
   * @return le builder
   */
  public SedaConfigBuilder checkBinary(boolean checkBinary) {
   ...
   * @return le builder
   */
  public SedaConfigBuilder checkSize(boolean checkSize) {
   ...
   * @return le builder
   */
  public SedaConfigBuilder checkDigest(boolean checkDigest) {
   ...
   * @return le builder
   */
  public SedaConfigBuilder useMemory(boolean useMemory) {
   ...
   * @return le builder
   */
  public SedaConfigBuilder identifyFileFormat(boolean identifyFileFormat) {
   ...
   */
  public SedaConfig build() {
    return new SedaConfig(
        validate,
        format,
        indent,
        thread,
