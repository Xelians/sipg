...
/**
 * La classe Fntcv4ConfigBuilder facilite la création d'un objet Fntcv4Config en suivant le principe
...
public class Fntcv4ConfigBuilder {
  ...
  public Fntcv4Config build() {
    return new Fntcv4Config(
        validate, format, indent, thread, strict, checkBinary, checkSize, checkDigest, useMemory);
  }
}
