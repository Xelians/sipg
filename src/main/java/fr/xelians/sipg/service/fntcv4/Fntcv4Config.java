...
/**
 * La classe Fntcv4Config représente la configuration utilisée lors de la sérialisation d'une archive au format FNTC v4.
 * Les valeurs par défaut sont définies dans la classe Fntcv4ConfigBuilder.
 *
