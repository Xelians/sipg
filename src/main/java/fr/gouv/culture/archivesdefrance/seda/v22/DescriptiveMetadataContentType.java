 ...
 *       <sequence>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.2}ObjectGroup"/>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.2}ManagementHistoryGroup" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class DescriptiveMetadataContentType {
    ...
    /**
     * Réponse au système émetteur d'un message électronique.
     * 
     */
     ...
     * not a snapshot. Therefore, any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the signature property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
