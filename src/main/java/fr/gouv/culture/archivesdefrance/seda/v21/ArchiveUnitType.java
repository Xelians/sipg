...
public class ArchiveUnitType {
  ...
  // $ed
  //    @XmlElementRefs({
  //        @XmlElementRef(name = "ArchiveUnit", namespace =
  // "fr:gouv:culture:archivesdefrance:seda:v2.1", type = JAXBElement.class, required = false),
  //        @XmlElementRef(name = "DataObjectReference", namespace =
  // "fr:gouv:culture:archivesdefrance:seda:v2.1", type = JAXBElement.class, required = false),
  //        @XmlElementRef(name = "DataObjectGroup", namespace =
  // "fr:gouv:culture:archivesdefrance:seda:v2.1", type = JAXBElement.class, required = false)
  //    })
   ...
   * JAXBElement }{@code <}{@link ArchiveUnitType }{@code >} {@link JAXBElement }{@code <}{@link
   * DataObjectRefType }{@code >} {@link JAXBElement }{@code <}{@link ObjectGroupRefType }{@code >}
