...
@XmlType(
    name = "AuthorizationOriginatingAgencyRequestReplyType",
...
public class AuthorizationOriginatingAgencyRequestReplyType
  ...
  /** Service d’archives à l’origine de la demande d’autorisation. */
  @XmlElement(name = "ArchivalAgency", required = true)
  protected OrganizationWithIdType archivalAgency;

  /** Service producteur responsable de l’instruction de la demande d’autorisation. */
