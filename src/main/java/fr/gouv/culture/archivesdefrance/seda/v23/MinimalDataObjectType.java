...
public abstract class MinimalDataObjectType {
  ...
  /**
   * Identifiant attribué aux groupes d'objets de données. Il est attribué par le SAE et correspond
   * à un identifiant interne.
   */
  ...
  /**
   * Version d’un objet-données (par exemple : original papier, conservation, diffusion, vignette,
   * txt, …).
   */
   ...
   * Permet de spécifier un lien technique entre un objet-données et une signature.
   *
   * <p>Gets the value of the relationship property.
   *
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the relationship property.
   *
   ...
   *
   * @return The value of the relationship property.
   */
  ...
  /**
   * Sets the value of the dataObjectUse property.
   *
   * @param value allowed object is {@link String }
  ...
  /**
   * Sets the value of the dataObjectNumber property.
   *
