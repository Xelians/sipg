 ...
 *       <sequence>
 *         <element name="DataObjectProfile" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}IdentifierType" minOccurs="0"/>
 *         <element name="DataObjectSystemId" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="DataObjectGroupSystemId" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="Relationship" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}RelationshipType" maxOccurs="unbounded" minOccurs="0"/>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.3}DataObjectVersionGroup" minOccurs="0"/>
 *         <element name="DataObjectVersion" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}VersionIdType" minOccurs="0"/>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.3}PersistentIdentifierGroup" minOccurs="0"/>
 *         <element name="DataObjectUse" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="DataObjectNumber" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *       </sequence>
 *       <attribute name="id" use="required" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}DataObjectIdType" />
 *     </restriction>
 *   </complexContent>
 * </complexType>
 * }</pre>
...
public abstract class MinimalDataObjectType {
    ...
    /**
     * Usage d’un objet donné (par exemple : original papier, conservation, diffusion, vignette, txt, …).
     * 
     */
    @XmlElement(name = "DataObjectUse")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String dataObjectUse;
    /**
     * Version d'un objet donné pour un usage donné
     * 
     */
    @XmlElement(name = "DataObjectNumber")
    protected Integer dataObjectNumber;
    /**
    ...
    /**
     * Définit la valeur de la propriété dataObjectUse.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     * @see #getDataObjectUse()
     */
    public void setDataObjectUse(String value) {
        this.dataObjectUse = value;
    }
    ...
    /**
     * Définit la valeur de la propriété dataObjectNumber.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     * @see #getDataObjectNumber()
     */
    public void setDataObjectNumber(Integer value) {
        this.dataObjectNumber = value;
    }
