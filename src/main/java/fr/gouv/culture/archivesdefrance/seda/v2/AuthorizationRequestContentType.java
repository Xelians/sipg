...
public class AuthorizationRequestContentType {
   ...
   * Commentaire sur la transaction.
   *
   * <p>Gets the value of the comment property.
   *
   ...
   * Réponse à la demande d’autorisation.
   *
   * <p>Gets the value of the authorizationRequestReply property.
   *
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the authorizationRequestReply property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * BusinessAuthorizationRequestReplyMessageType }
   *
   * @return The value of the authorizationRequestReply property.
   */
