...
@XmlType(
    name = "KeywordsType",
    propOrder = {"keywordContent", "keywordReference", "keywordType"})
public class KeywordsType {
  ...
  /**
   * Identifiant du mot clé dans un référentiel donné. Par exemple, pour un lieu, il pourrait s'agir
   * de son code officiel géographique selon l'INSEE.
   */
