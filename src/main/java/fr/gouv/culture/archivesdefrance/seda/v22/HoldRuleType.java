...
public class HoldRuleType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Rule", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "StartDate", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "HoldEndDate", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "HoldOwner", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "HoldReassessingDate", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "HoldReason", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "PreventRearrangement", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.2", type = JAXBElement.class, required = false)
    })
    ...
    /**
     * L'identifiant de la règle spécifiée pourra être retirée
     *                             de l'héritage dans ce noeud.
     * 
     */
