...
public class ArchiveUnitType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "ArchiveUnit", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "DataObjectReference", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "DataObjectGroup", namespace = "fr:gouv:culture:archivesdefrance:seda:v2.3", type = JAXBElement.class, required = false)
    })
