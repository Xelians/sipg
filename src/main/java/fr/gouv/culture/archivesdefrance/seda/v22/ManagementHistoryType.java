...
@XmlType(
    name = "ManagementHistoryType",
    propOrder = {"updateDate", "data"})
public class ManagementHistoryType {
   ...
   * Data
   *
   * @return possible object is {@link ManagementHistoryDataType }
   */
   ...
   *
   * @param value allowed object is {@link ManagementHistoryDataType }
   * @see #getData()
   */
