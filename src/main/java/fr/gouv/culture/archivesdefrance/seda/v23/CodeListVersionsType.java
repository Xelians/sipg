 ...
 *       <sequence>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.3}TransportCodeListsGroup"/>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.3}TechnicalCodeListsGroup"/>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.3}ManagementCodeListsGroup"/>
 *         <element name="AcquisitionInformationCodeListVersion" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}CodeType" minOccurs="0"/>
 *         <element name="AuthorizationReasonCodeListVersion" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}CodeType" minOccurs="0"/>
 *         <element name="RelationshipCodeListVersion" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}CodeType" minOccurs="0"/>
