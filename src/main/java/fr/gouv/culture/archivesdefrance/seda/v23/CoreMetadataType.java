 ...
 *       <choice>
 *         <element name="Text" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}TextTechnicalMetadataType"/>
 *         <element name="Document" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}DocumentTechnicalMetadataType"/>
 *         <element name="Image" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}ImageTechnicalMetadataType"/>
 *         <element name="Audio" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}AudioTechnicalMetadataType"/>
 *         <element name="Video" type="{fr:gouv:culture:archivesdefrance:seda:v2.3}VideoTechnicalMetadataType"/>
