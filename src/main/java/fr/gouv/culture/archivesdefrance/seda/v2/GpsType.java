...
public class GpsType {
  ...
  /**
   * 2)Si la latitude est exprimée en degrés, minutes et secondes, le format type est dd, mm, ss.
   * Par ex: "45 18 46.922".
   */
  ...
  /**
   * Indique si la latitude est nord ou sud. La valeur 'N' indique la latitude nord, et 'S' indique
   * la latitude sud.
   */
  ...
  /**
   * 2)Si la longitude est exprimée en degrés, minutes et secondes, le format type est dd, mm, ss.
   * Par ex: "5 23 32.229".
   */
  ...
  /**
   * Indique si la longitude est est ou ouest. La valeur 'E' indique la longitude est, et 'W'
   * indique la longitude Ouest.
   */
