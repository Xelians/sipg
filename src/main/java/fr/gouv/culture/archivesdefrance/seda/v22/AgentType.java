 ...
 * 
 * <p>Classe Java pour AgentType complex type.</p>
 * 
 ...
 *       <sequence>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.2}PersonOrEntityGroup"/>
 *         <group ref="{fr:gouv:culture:archivesdefrance:seda:v2.2}BusinessGroup"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class AgentType {
     ...
     * This is why there is not a {@code set} method for the nationality property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore, any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the position property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * not a snapshot. Therefore, any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the mandate property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
