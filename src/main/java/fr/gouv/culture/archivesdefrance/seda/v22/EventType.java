 ...
 *       <sequence>
 *         <element name="EventIdentifier" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="EventTypeCode" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="EventType" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="EventDateTime" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}DateType"/>
 *         <element name="EventDetail" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}TextType" minOccurs="0"/>
 *         <element name="Outcome" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="OutcomeDetail" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="OutcomeDetailMessage" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="EventDetailData" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}NonEmptyTokenType" minOccurs="0"/>
 *         <element name="LinkingAgentIdentifier" type="{fr:gouv:culture:archivesdefrance:seda:v2.2}LinkingAgentIdentifierType" maxOccurs="unbounded" minOccurs="0"/>
