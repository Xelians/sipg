...
public class ArchiveUnitType {
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link ArchiveUnitType
     * }*
     *
    ...
    public static class DataObjectReference {
         ...
         */
        @XmlElementRef(name = "DataObjectReferenceId", namespace = "org:fntc:ta:v4.0", type = JAXBElement.class)
         ...
         * method for the dataObjectReferenceId property.
         *
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
