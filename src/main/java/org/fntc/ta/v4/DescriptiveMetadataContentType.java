...
public class DescriptiveMetadataContentType {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the dataObjectSystemId property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the originatingSystemId property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the archivalAgencyArchiveUnitIdentifier property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the originatingAgencyArchiveUnitIdentifier property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the transferringAgencyArchiveUnitIdentifier property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
